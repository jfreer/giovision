                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                               ...
                               <form method="post" enctype="multipart/form-data" class="form-horizontal" id="update_internal_job">
                                   <div class="card-body card-block" id="internal_form">
                                       ...
                                       <div class="row form-group">
                                           ...
                                           <div class="col-2">
                                               <input type="text" name="i-spares-input[]" id="i-spares-input" class="form-control" placeholder="Spares">
                                           </div>
                                           <div class="col-2">
                                               <input type="text" name="i-qty-input[]" id="i-spares-input" class="form-control" placeholder="Qty">
                                           </div>
                                           <div class="col-2">
                                               <input type="text" name="i-amount-input[]" id="i-spares-input" class="form-control" placeholder="Amount">
                                           </div>
                                       </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" id="create_pdf">Download PDF</button>
                                <button type="button" class="btn btn-secondary" id="update_internal_job">Update</button>
                                    ...
                                    <div class="card-body card-block" id="external_form">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                ...
                                                <textarea name="e-description-input" id="e-description-input" rows="4" placeholder="Content..." class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <button type="submit" name="insert" id="insert" value="Insert" value="Insert" class="btn btn-primary btn-sm">
