    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                ...
                <!-- MODALS-->
                <?php include("include/index/add-customer-modal.php"); ?>
                <?php include("include/index/update-customer-modal.php"); ?>
                <?php include("include/index/start-job-for-new-customer-modal.php"); ?>
                <!-- END MODALS-->
