...
if(isset($_POST)){
	...
	insert_spare_list($conn, $external_job_id);

	$sql = "INSERT INTO external_jobs (external_job_id, cust_id, invoice, article, model_no, fault, damages, description, aux_equip, date) 
	VALUES ('$external_job_id', '$cust_id', '$invoice', '$article', '$model_no', '$fault', '$damages', '$description', '$aux_equip', '$date')";
