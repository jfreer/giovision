...
if(isset($_POST)){
	...
	$sql = "INSERT INTO customer (cust_id, name, residential_address, postal_address, tel_no, cell_no, email, payment_method, multichoice_acc, sabc_license, date)
	VALUES ('$cust_id', '$name', '$residential_address', '$postal_address', '$tel_no', '$cell_no', '$email', '$payment_method', '$multichoice_acc', '$sabc_license', '$date')";
